...
# INPUTS
#raiz = "X:/Sigmagis/Projetos/RADAR/RELATORIO MONITORAMENTO ATIVO EXEMPLO/GUARIROBA"
#shp = 'AREA_NDVI_GUARIROBA.shp'
#PASTA_NDVI = "X:/Sigmagis/Projetos/Grupo Clealco/NDVI/BERNARDO IDE/NDVI/"
#upscale_factor = 4   #Divisor pxl, sentinel=4, LandSat=12

def extract(raiz, shp, upscale_factor):

    # PASTAS
    BASE_NDVI = os.path.join(raiz, 'Vetores/Shape/', shp)
